        ...
        <Container className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_2fr]">
          ...
          <div className="max-w-3xl">
            <div className="space-y-6 font-display text-2xl font-medium leading-snug tracking-tight sm:text-3xl">
              <p>
                Пишу смело, редачу деликатно. Строю контент-стратегии,
                настраиваю конвейер: подбираю и веду аутсорс-авторов.
                Включаю UX thinking, когда нужно.
              </p>
              <p>
                Без брезгливости берусь за любой формат: от лаконичных смс
                и баннеров до сложных лонгридов и лендингов. С кайфом
                возьмусь за курс, сайт, книгу, соцсети или вайт-пейпер —
                пишу рассылки, инструкции, тексты для приложений и личных
                кабинетов. Мультиформатный, омниканальный редактор.
              </p>
              <p className="text-muted">
                Пишу на русском (C2) и английском (C1). В профессии 9 лет.
                На связи в рабочее время по Москве — оперативно решаю
                вопросы и держу контакт с заказчиками. Работаю по ТК или
                ИП: есть шаблон договора, КЭП и ЭДО, полный комплект.
              </p>
            </div>
