          ...
          <div className="max-w-3xl">
            <div className="space-y-6 font-display text-2xl font-medium leading-snug tracking-tight sm:text-3xl">
              ...
              <p className="text-muted">
                Включаю UX thinking, когда нужно. Пишу и редачу на русском
                (C2) и английском (C1) — кейсы обоих языков смотрите в
                работах ниже. Без брезгливости берусь за любой формат: от
                смс и баннеров до лонгридов, курсов и книг. Работаю по ТК
                или ИП — есть шаблон договора, КЭП и ЭДО, полный комплект.
              </p>
            </div>
