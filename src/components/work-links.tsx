      ...
      <div className="flex min-w-0 gap-4 overflow-x-auto pb-2 [scrollbar-width:thin]">
        {links.map((link) => (
          <a
            ...
            className="group flex w-80 shrink-0 flex-col justify-between gap-8 rounded-2xl border border-border bg-card p-6 shadow-sm transition-colors hover:border-accent hover:bg-background"
          >
