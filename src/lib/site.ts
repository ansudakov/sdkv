...
export const workCases: WorkCase[] = [
  {
    ...
    body: [
      ...
      "Запустил ежемесячный дайджест обновлений — статья, рассылка и пост в телеграме, 12 выпусков в год; такого формата у других российских облаков нет. Выстроил систему клиентских кейсов двух видов — про внутреннюю кухню компании и истории клиентов — с дорожной картой, вопросами для интервью и единой структурой.",
