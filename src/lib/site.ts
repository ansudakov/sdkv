...
export const workCases: WorkCase[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Были и технические тексты для раздела «Помощь» на сайте — в Яндексе его традиционно называют «Справкой». С нуля запустили этот раздел и наполнили его инструкциями по всем продуктам, которые были на тот момент.",
    ],
    highlights: [
