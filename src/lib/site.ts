...
export const workCases: WorkCase[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Были и технические тексты для раздела «Помощь» на сайте. В Яндексе этот раздел традиционно называют «Справкой». Мы с нуля запустили этот раздел и наполнили его инструкциями по всем продуктам, которые были на тот момент.",
    ],
    highlights: [
