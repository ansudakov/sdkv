...
export const workCases: WorkCase[] = [
  {
    ...
    body: [
      ...
      "Переписал все продуктовые лендинги на сайте и запустил новые — около 100 страниц: опирались на конверсию, SEO и то, насколько быстро текст считывается. Разработал ToV — не гиковский, но технически подкованный язык, с терминами разработчиков внутри энергичного текста.",
      "Проапгрейдил сервисные и маркетинговые рассылки: сервисные перестали быть роботизированными, маркетинговые — продающими. Общаемся с клиентами так, будто помогаем им в личном разговоре.",
      "Перепродумал телеграм-канал компании: вместо контента ради контента — ресурсный подход. Клиенты просят фичу в личном кабинете → разработчики её выпускают → мы рассказываем в канале, как ей пользоваться. Канал вырос с 2 000 до 10 000 подписчиков и стал источником для остальных соцсетей.",
      "Запустил ежемесячный дайджест обновлений — статья, рассылка и пост в телеграме, 12 выпусков в год; такого формата у других российских облаков нет.",
      "Кейсы — два вида: про внутреннюю кухню компании (контент, CRM, SEO, редизайн личного кабинета, поддержка) и истории клиентов о переходе в Timeweb Cloud. Составил дорожную карту, вопросы для интервью, единую структуру и ToV — всё, чтобы кейсы выходили на потоке и без меня.",
  ...
  },
  {
    ...
    body: [
      ...
      "Занимался неймингом — продукты, мероприятия, акции, мерч. Строил воронку аутсорс-авторов почти на 1000 человек: сотня прошла тестовое, из них — десятка лучших, в штат взял четверых.",
