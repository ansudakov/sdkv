...
export const workCases: WorkCase[] = [
  {
    ...
    body: [
      ...
      "Кейсы — два вида: про внутреннюю кухню компании (контент, CRM, SEO, редизайн личного кабинета, поддержка) и истории клиентов о переходе в Timeweb Cloud и результатах. Составил дорожную карту, вопросы для интервью, единую структуру и ToV — всё, чтобы кейсы выходили на потоке и без меня.",
